...
<h1>Where's My Cupcake - 2 player game simulator</h1>
...
echo "<table>\n<tr>\n<th>&nbsp;</th><th>Player A</th><th>Player B</th></tr>\n";
...
for ($game=1; $game <= $games; $game++) {
	...
	// prepare the plates
	$theplatescakecount = array(0,0);
	$theplatestopcard = array(0,0);
	
	// The game loop begins
	for ($round=0; $round <= 29; $round++) {

		// Whose turn is it?
		if ($round == 0 || $round == 2 || $round == 4 || $round == 6 || $round == 8 || $round == 10 || $round == 12 || $round == 14 || $round == 16 || $round == 18 || $round == 20 || $round == 22 || $round == 24 || $round == 26 || $round == 28) { $playerid = 0;}
		elseif ($round == 1 || $round == 3 || $round == 5 || $round == 7 || $round == 9 || $round == 11 || $round == 13 || $round == 15 || $round == 17 || $round == 19 || $round == 21 || $round == 23 || $round == 25 || $round == 27 || $round == 29) { $playerid = 1;}
		else {}
...
echo "<h2>Tally</h2>\n";
// Headers
echo "<table border=\"1\">\n<tr>\n<th>Player A</th><th>Player B</th></tr>\n";
